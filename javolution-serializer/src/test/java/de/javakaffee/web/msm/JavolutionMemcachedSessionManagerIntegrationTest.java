...
import de.javakaffee.web.msm.serializer.javolution.JavolutionTranscoderFactory;
 ...
 */
public class JavolutionMemcachedSessionManagerIntegrationTest {

    private static final Log LOG = LogFactory.getLog( JavolutionMemcachedSessionManagerIntegrationTest.class );
    ...
    public void setUp() throws Throwable {
        ...
        try {
            ...
            _tomcat1 = createCatalina( _portTomcat1, memcachedNodes, "app1", JavolutionTranscoderFactory.class.getName() );
            _tomcat1.start();
